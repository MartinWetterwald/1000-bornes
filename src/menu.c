...
void afficher_logo()
{
    ...
    printfEx(COULEUR_VOITURE, "                      ,,:::::::,,+:,:::::,,,,,,,,......:,..,,,,',,;\n");
    printfEx(COULEUR_VOITURE, "                     .:::::::::,,,:::::::::,,,,,,,,,..,....,.,,,,,,. ;\n");
    printfEx(COULEUR_VOITURE, "                   '::::::::"); printfEx(COULEUR_VOITURE_ROUES, "#+++++");       printfEx(COULEUR_VOITURE, "':,,::::,,,,,,,,,,+..");printfEx(COULEUR_VOITURE_ROUES, "+++++++");         printfEx(COULEUR_VOITURE, ",,:,;``;\n");
    printfEx(COULEUR_VOITURE, "                +::::::::,");   printfEx(COULEUR_VOITURE_ROUES, "##::::'+#");    printfEx(COULEUR_VOITURE, ":::::::,,,,,,,,,,,");   printfEx(COULEUR_VOITURE_ROUES, "+#:::,;+#");       printfEx(COULEUR_VOITURE, ",,::.``\n");
    printfEx(COULEUR_VOITURE, " `,            #::::::::");     printfEx(COULEUR_VOITURE_ROUES, "+#:;:;::,##");  printfEx(COULEUR_VOITURE, ":,:::::,,,,,,,,,");     printfEx(COULEUR_VOITURE_ROUES, "##:;::::,+#");     printfEx(COULEUR_VOITURE, ":::,``#\n");
    printfEx(COULEUR_VOITURE, "    .     `     :,::::::");     printfEx(COULEUR_VOITURE_ROUES, "#+;;.'``;:,#"); printfEx(COULEUR_VOITURE, ",::::::::,,,,,,");      printfEx(COULEUR_VOITURE_ROUES, "#+;;;;+;::,#");    printfEx(COULEUR_VOITURE, ",:::,#+\n");
    printfEx(COULEUR_VOITURE, "     .  +  `     ..```..");     printfEx(COULEUR_VOITURE_ROUES, "#+';'````::+#");printfEx(COULEUR_VOITURE, ",:::::,,,,,,,,");       printfEx(COULEUR_VOITURE_ROUES, "##;'+;``.::#+");   printfEx(COULEUR_VOITURE, ",::::,\n");
    ...
    printf("\n");
    printfEx(COULEUR_VOITURE_ROUES, "    _   __     __     __       ___    _____  ___    _   _  ___    ___   \n");
    printfEx(COULEUR_VOITURE_ROUES, " /' )/' _`\\ /' _`\\ /' _`\\    (  _`\\ (  _  )|  _`\\ ( ) ( )(  _`\\ (  _`\\ \n");
    printfEx(COULEUR_VOITURE_ROUES, "(_, || ( ) || ( ) || ( ) |   | (_) )| ( ) || (_) )| `\\| || (_(_)| (_(_)\n");
    printfEx(COULEUR_VOITURE_ROUES, "  | || | | || | | || | | |   |  _ <'| | | || ,  / | , ` ||  _)_ `\\__ \\ \n");
    printfEx(COULEUR_VOITURE_ROUES, "  | || (_) || (_) || (_) |   | (_) )| (_) || |\\ \\ | |`\\ || (_( )( )_) |\n");
...
void afficher_licence()
{
    ...
    printf("Vous pouvez télécharger le code source de cette application librement à l'adresse : http://github.com/djfox/1000-bornes\n");
    sleep(4);
}
